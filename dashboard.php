...
<span style="display:flex;flex-direction:row;"><i class="fa fa-tachometer" aria-hidden="true" style="color:white;"></i><a href="dashboard.php">Dashboard</a></span>

  <span style="display:flex;flex-direction:row;"><i class="fa fa-tasks" aria-hidden="true"></i><a href="subjects.php">Subjects </a></span>
  <button class="dropdown-btn"><i class="fa fa-folder" aria-hidden="true"></i>Documents 
  <i class="fa fa-chevron-down" aria-hidden="true"></i>
  </button>
  <div class="dropdown-container">
  <span style="display:flex;flex-direction:row;"><i class="fa fa-folder" aria-hidden="true"></i><a href="documents.php">View documents</a></span>
  </div>
  <button class="dropdown-btn"><i class="fa fa-id-card" aria-hidden="true"></i>Exam Info 
  <i class="fa fa-chevron-down" aria-hidden="true"></i>
  </button>
  <div class="dropdown-container">
  <span style="display:flex;flex-direction:row;"><i class="fa fa-file-excel-o" aria-hidden="true"></i><a href="datesheet.php">Datesheet</a></span>

  </div>
  <span style="display:flex;flex-direction:row;"><i class="fa fa-key" aria-hidden="true"></i><a href="passchange.php">Change Password</a></span>
  <span style="display:flex;flex-direction:row;"><i class="fa fa-sign-out" aria-hidden="true"></i> <a href="studenthome.php">LogOut</a> </span>
  </div>
...
font-family: 'Oswald', sans-serif;text-align:center;color:black;font-size:35px;">  SUBJECTS</h2>
    <a href="subjects.php" class="btn ">More Info<i class="fa fa-arrow-right" aria-hidden="true" style="background:white;border-radius:15px;padding:6px;color:green;  "></i></a>
</div>    
    </div>
</div>
<!-- <div class="col-12 mb-2 col-md-12 col-xl-4">
...
font-family: 'Oswald', sans-serif;text-align:center;color:black;font-size:35px;">  VIEW DOCUMENTS </h2>
    <a href="documents.php" class="btn">More Info<i class="fa fa-arrow-right" aria-hidden="true" style="background:white;border-radius:15px;padding:6px;color:green;  "></i></a>
</div> 
...
font-family: 'Oswald', sans-serif;text-align:center;color:black;font-size:35px;"> DATESHEET </h2>
    <a href="datesheet.php" class="btn">More Info<i class="fa fa-arrow-right" aria-hidden="true" style="background:white;border-radius:15px;padding:6px;color:green;  "></i></a>
</div> 
